 ...
 */
public class KoscielnyProduct extends AbstractSequentialGenerator {
	...
	public ILatinSquare generateLS() {
		...
		if (n2==1) {
			...
			return new SeqGenWithBacktracking(n).generateLS();//#genLS.genLS(n)
		}

		ILatinSquare ls1 = new SeqGenWithBacktracking(n1).generateLS();
		ILatinSquare ls2 = new SeqGenWithBacktracking(n2).generateLS();
